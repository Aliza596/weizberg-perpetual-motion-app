...
import com.Interfaces.AdapterOnItemClickListener;
...
// The message to show on the bottom of the outer card (e.g "Cards inStack: ")
    ...
    private void populateAndShowInnerCard (CardPileTopViewHolder holder, int
            position)
    {
    ...
    {
        int currentColor = getCurrentColorWithNightMode (currentCard);  // this line has the change to the original method
